...
const Table = ({ headers, rows, rowKey, customStyles, route, onDelete, update_status, onShow, OnUpdate }) => {
                                                    ...
                                                    header.key === "vendor" && typeof (row.vendor) === "object" ?
                                                        ...
                                                        : header.key === "actions" ?
                                                            ...
                                                            <div className="flex justify-center items-center gap-2">
                                                                <button className="p-1 bg-green-500 hover:bg-green-600 text-white rounded-md"
                                                                    onClick={() => OnUpdate(rowId)}>Update</button>
